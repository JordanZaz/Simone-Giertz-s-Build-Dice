...
var sm = (function(undefined){
	...
	var tMax = 3000, // animation time, ms
		...
		r = [],
		reels = [
		  ['House Ware',   'Gift',       'Fashion', 'Vehicle', 'Art', 'Furniture'],
			['Wood',  'Card Board', 'Fabric', 'Metal', 'Trash', 'Cement/Clay'],
			['Extra Big/Small', 'Low Budget',    'Makes Music', 'No Powertool', 'One Day Build', 'Not Useful']
		],
		$reels, $msg,
		start;
